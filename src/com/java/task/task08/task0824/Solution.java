package com.java.task.task08.task0824;
...
public class Solution {
    public static void main (String[]args){
        ...
        Human child1 = new Human("Маша", true, 10, null);
        Human child2 = new Human("Даша", false, 12, null);
        Human child3 = new Human("Мила", false, 13, null);
